...
import io.asemantonium.android.AsemanToniumServiceDelegate;
import org.qtproject.qt5.android.bindings.QtApplication;

public class AsemanToniumService extends Service
{
    ...
    private static AsemanToniumService m_instance = null;
    ...
    public static AsemanToniumService getServiceInstance() {
        return AsemanToniumService.m_instance;
    }
    ...
    public void onDestroy() {
        AsemanToniumServiceDelegate.finishQtApplication();
        m_serviceInfo = null;
        m_instance = null;
        m_classLoader = null;
        super.onDestroy();
...
//            Toast.makeText(getBaseContext(), m_lib_name + " starting", Toast.LENGTH_LONG).show();
            ...
            try{
                ...
                if (m_serviceInfo.metaData.containsKey("android.app.use_local_qt_libs")
                    ...
                    loaderParams.putString(LOADER_CLASS_NAME_KEY, "io.asemantonium.android.AsemanToniumServiceDelegate");
