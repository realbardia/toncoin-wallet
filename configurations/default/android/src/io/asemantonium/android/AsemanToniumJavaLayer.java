...
import io.asemantonium.android.AsemanToniumApplication;
import io.asemantonium.android.AsemanToniumActivity;
import io.asemantonium.android.AsemanToniumQtService;
...
public class AsemanToniumJavaLayer
{
    ...
    public static void setKeepScreenOn(boolean status) {
        ...
        final AsemanToniumActivity activtiy = AsemanToniumActivity.getActivityInstance();
    ...
    {
        Rect r = new Rect();
        Window window = AsemanToniumActivity.getActivityInstance().getWindow();
    ...
    public static void sendImage( Uri data ) {
        String imagePath = "/sdcard/AsemanTonium/tmp_input_image.jpg";

        File file = new File(imagePath);
        file.delete();

        try {
            InputStream stream = AsemanToniumApplication.instance().getContentResolver().openInputStream(data);
    ...
    {
        Context oContext;
        oContext = AsemanToniumApplication.getAppContext();
    ...
    public static Context getContext() {
        if(AsemanToniumActivity.getActivityInstance() != null)
            return AsemanToniumActivity.getActivityInstance();
        else
        if(AsemanToniumQtService.getServiceInstance() != null)
            return AsemanToniumQtService.getServiceInstance();
        else
            return AsemanToniumApplication.getAppContext();
    }
    ...
    boolean startQtService()
    {
        Context oContext;
        oContext = AsemanToniumApplication.getAppContext();
        Intent i = new Intent(oContext, AsemanToniumQtService.class);
    ...
    DisplayMetrics getMetrics()
    {
        ...
        try {
            AsemanToniumActivity.getActivityInstance().getWindowManager().getDefaultDisplay().getMetrics(dm);
        } catch(Exception e) {
            return dm;
        }
        return dm;
    ...
    int statusBarHeight() {
        int result = 0;
        Context context = AsemanToniumApplication.getAppContext();
    ...
    boolean getOpenPictures()
    {
        ...
        try {
            AsemanToniumActivity.getActivityInstance().startActivityForResult(intent, AsemanToniumActivity.SELECT_IMAGE);
        } catch(Exception e) {
            return false;
        }
    ...
    boolean startCamera( String output )
    {
        ...
        try {
            AsemanToniumActivity.getActivityInstance().startActivityForResult(intent, 0);
        } catch(Exception e) {
            return false;
        }
        return true;
    ...
    boolean callNumber( String number )
    {
        ...
        try {
            AsemanToniumActivity.getActivityInstance().startActivity(intent);
        } catch(Exception e) {
            return false;
        }
        return true;
    ...
    {
        return AsemanToniumActivity.getActivityInstance().transparentStatusBar();
    }

    boolean transparentNavigationBar()
    {
        return AsemanToniumActivity.getActivityInstance().transparentNavigationBar();
    }
    ...
    boolean setTransparentNavigationBar(boolean stt)
    {
        ...
        Handler mainHandler = new Handler(AsemanToniumActivity.getActivityInstance().getMainLooper());
        Runnable myRunnable = new Runnable() {
            @Override
            public void run() {
                AsemanToniumActivity.getActivityInstance().setTransparentNavigationBar(_stt);
            }
        };
        mainHandler.post(myRunnable);
        return true;
    ...
    boolean setTransparentStatusBar(boolean stt)
    {
        ...
        Runnable myRunnable = new Runnable() {
            @Override
            public void run() {
                AsemanToniumActivity.getActivityInstance().setTransparentStatusBar(_stt);
            }
        };
        mainHandler.post(myRunnable);
        return true;
    ...
    public String createNotificationChannel(String channelId ,String channelName, int importance){
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            if(AsemanToniumActivity.getActivityInstance() != null)
                return AsemanToniumActivity.getActivityInstance().createNotificationChannel(channelId, channelName, importance);
            else
            if(AsemanToniumQtService.getServiceInstance() != null)
                return AsemanToniumQtService.getServiceInstance().createNotificationChannel(channelId, channelName, importance);
        } else {
            return "";
        }
        return channelId;
    ...
    {
        if(AsemanToniumQtService.getServiceInstance() != null)
            return AsemanToniumQtService.getServiceInstance().startForeground(id, title, body, iconPath, icon, channelId);
        return false;
    }
    ...
    {
        if(AsemanToniumQtService.getServiceInstance() != null) {
            AsemanToniumQtService.getServiceInstance().stopForeground(removeNotification);
            return true;
        }
        return false;
    }
    ...
    {
        if(AsemanToniumActivity.getActivityInstance() != null)
            return AsemanToniumActivity.getActivityInstance().startNotification(id, title, body, iconPath, icon, channelId, sound, vibrate);
        else
        if(AsemanToniumQtService.getServiceInstance() != null)
            return AsemanToniumQtService.getServiceInstance().startNotification(id, title, body, iconPath, icon, channelId, sound, vibrate);
        return false;
    }
    ...
    {
        if(AsemanToniumActivity.getActivityInstance() != null)
            return AsemanToniumActivity.getActivityInstance().stopNotification(id);
        else
        if(AsemanToniumQtService.getServiceInstance() != null)
            return AsemanToniumQtService.getServiceInstance().stopNotification(id);
        return false;
    }
