...
void TonToolkitMacManager::removeTitlebarFromWindow(double r, double g, double b)
{
...
bool TonToolkitMacManager::hasBiometric()
{
...
bool TonToolkitMacManager::biometricCheck()
{
    LAContext *context = [[LAContext alloc] init];
    NSError *error = nil;
