#ifndef TONTOOLKITAPPLICATION_H
#define TONTOOLKITAPPLICATION_H
...
#define DEFAULT_AAPP_TYPE TonToolkitApplication::CoreApplication
#endif
#endif
...
public:
    ...
    TonToolkitApplication(int &argc, char **argv, ApplicationType appType = DEFAULT_AAPP_TYPE);
    virtual ~TonToolkitApplication();
    ...
    static TonToolkitApplication *instance();
