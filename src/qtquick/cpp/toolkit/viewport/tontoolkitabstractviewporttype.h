#ifndef TONTOOLKITABSTRACTVIEWPORTTYPE_H
#define TONTOOLKITABSTRACTVIEWPORTTYPE_H
...
class TonToolkitAbstractViewportType : public QQuickItem
{
    Q_OBJECT
...
public:
    TonToolkitAbstractViewportType(QQuickItem *parent = Q_NULLPTR);
    virtual ~TonToolkitAbstractViewportType();
...
class TonToolkitViewportTypeAttechedProperty;
class TonToolkitViewportType : public QObject
{
    Q_OBJECT
public:
    static TonToolkitViewportTypeAttechedProperty *qmlAttachedProperties(QObject *object);
};

class TonToolkitViewportTypeAttechedProperty : public QObject {
    Q_OBJECT
    Q_PROPERTY(qreal gestureWidth READ gestureWidth WRITE setGestureWidth NOTIFY gestureWidthChanged)
    Q_PROPERTY(qreal maximumWidth READ maximumWidth WRITE setMaximumWidth NOTIFY maximumWidthChanged)
...
public:
    TonToolkitViewportTypeAttechedProperty(QObject *parent);
    virtual ~TonToolkitViewportTypeAttechedProperty();
...
QML_DECLARE_TYPEINFO(TonToolkitViewportType, QML_HAS_ATTACHED_PROPERTIES)

#endif // TONTOOLKITABSTRACTVIEWPORTTYPE_H
