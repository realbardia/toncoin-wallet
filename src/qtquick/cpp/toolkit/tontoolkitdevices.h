...
#ifndef TONTOOLKITDEVICES_H
#define TONTOOLKITDEVICES_H
...
class TonToolkitMimeData;
class QScreen;
class TonToolkitDevicesPrivate;
class TonToolkitDevices : public QObject
{
    Q_OBJECT
...
public:
    enum Flags {
        DisableDensities,
        TonToolkitScaleFactorEnable
    };

    TonToolkitDevices(QObject *parent = Q_NULLPTR);
    virtual ~TonToolkitDevices();
